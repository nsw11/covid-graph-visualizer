 ...
 * afterwards.
 */
var NodeDisplayData = /** @class */ (function () {
    ...
    NodeDisplayData.prototype.assign = function (data) {
        for (var key in data)
            this[key] = data[key];
    };
...
var EdgeDisplayData = /** @class */ (function () {
    ...
    EdgeDisplayData.prototype.assign = function (data) {
        for (var key in data)
            this[key] = data[key];
    };

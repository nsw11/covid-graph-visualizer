...
var EdgeQuadraticBezierProgram = /** @class */ (function (_super) {
    ...
    function EdgeQuadraticBezierProgram(gl) {
        var _this = _super.call(this, gl, edge_quadraticBezier_vert_glsl_1.default, edge_quadraticBezier_frag_glsl_1.default) || this;
        // Locations
    ...
    EdgeQuadraticBezierProgram.prototype.allocate = function (capacity) {
        this.array = new Float32Array(POINTS * ATTRIBUTES * capacity);
    };
    EdgeQuadraticBezierProgram.prototype.process = function (sourceData, targetData, data, offset) {
        var i = 0;
    ...
    EdgeQuadraticBezierProgram.prototype.bufferData = function () {
        var gl = this.gl;
        // Vertices data
